...
function PlaySoundButton({setPlayBGM, playBGM}) {
  return(
    <button onClick={() => setPlayBGM(!playBGM)} className="absolute flex items-center justify-center top-8 right-12 w-10 h-10 rounded-[8px] border-1 border-[blue] bg-slate-800 cursor-pointer ">
