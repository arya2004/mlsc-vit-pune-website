...
export default function NavButtons({showNavButtons}){
    ...
    return (
        ...
        <div className={cn(showNavButtons?"w-screen h-screen":"w-0 h-0 opacity-0 pointer-events-none","absolute top-0 left-0 right-0 bottom-0 z-50 flex lg:flex-row flex-col items-center justify-evenly text-[#f0f0f0] font-bold text-wrap ease-in-out duration-300")}>
