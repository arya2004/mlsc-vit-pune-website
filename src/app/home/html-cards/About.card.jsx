  ...
  return (
    <>
      <group position={[2.6, 1, -3]} rotation={[0, -Math.PI/6, 0]}>
        <Text fontSize={0.11} position={[0, 0.5, 0]} scale={[1,1, 1]} color='#0078d4' >Welcome to Microsoft Learn Student Club VIT, Pune:{'\n'}</Text>
        
        <Text fontSize={0.1} scale={[1, 1, 1]} color='#0078d4'>
          Join us on a journey of exploration and {'\n'} innovation at Microsoft Learn
          Student Club VIT, Pune! {'\n'} As passionate learners and tech enthusiasts, {'\n'}
