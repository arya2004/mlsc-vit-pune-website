...
const AboutMesh = () => {
  ...
  return (
    <Html>
      <div className="container align-center flex flex-col items-center justify-evenly w-[500px] h-[350px] p-3 bg-transparent rounded-[8px] text-2xl text-center text-[#94b3fdbd]">
        <div className={cn(!timer ?"font-bold":"font-bold glitch")} data-text="Welcome to Microsoft Learn Student Club VIT, Pune">
